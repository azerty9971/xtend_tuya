...
class XTTuyaIOTDeviceManagerInterface(XTDeviceManagerInterface):
    ...
    def get_webrtc_sdp_answer(self, device_id: str, session_id: str, sdp_offer: str) -> str | None:
        return self.iot_account.device_manager.ipc_manager.get_webrtc_sdp_answer(device_id, session_id, sdp_offer)
    
    def get_webrtc_ice_servers(self, device_id: str, session_id: str) -> str | None:
        return self.iot_account.device_manager.ipc_manager.get_webrtc_ice_servers(device_id, session_id)